...
api-error-invalid-fields = Неверно заполненные поля: { $fields }
api-error-invalid-submission = Отправленные данные неверны. Проверьте и отправьте снова.
api-error-registration-retry = Регистрация не удалась. Подождите немного и попробуйте снова.
