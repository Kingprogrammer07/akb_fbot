...
api-error-invalid-fields = Noto'g'ri to'ldirilgan maydonlar: { $fields }
api-error-invalid-submission = Yuborilgan ma'lumotlar noto'g'ri. Tekshirib, qayta yuboring.
api-error-registration-retry = Ro'yxatdan o'tish amalga oshmadi. Biroz kutib, qayta urinib ko'ring.
